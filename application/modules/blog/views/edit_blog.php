                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                         <form action="<?php echo site_url('blog/edit_blog'); ?>" role="form" id="addcategory" method="post" class="validate form-horizontal" enctype="multipart/form-data">

                                  <div class="form-group"><label class="col-sm-2 control-label">Blog Title</label>
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" placeholder="Blog Title" name="blog_title" id="blog_title" value="<?php echo $blog->blog_title; ?>">
                                  ...
                                  <div class="form-group"><label class="col-sm-2 control-label">Blog content</label>
                                    <div class="col-sm-10">
                                      <textarea placeholder="Write something.." id="blog_body" name="blog_body"><?php echo $blog->blog_body; ?></textarea>
